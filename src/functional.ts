...
function reverse<T extends (...args: any[]) => any>(fn: T): (...args: Reverse<Parameters<T>>) => ReturnType<T> {
...
const alt =
  ...
  (...arg: Parameters<F>): ReturnType<F> extends undefined | null ? ReturnType<G> : ReturnType<F> => {
    return f(...arg) || g(...arg)
  }
...
const fmap =
  ...
  <F extends (...args: any[]) => Parameters<W> extends [infer U] ? U : never>(fn: F) =>
...
const reactive =
  <T extends (...args: any[]) => any>(fn: T, wrapper: Wrapper<First<Parameters<T>>>) =>
